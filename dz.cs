...
//Создает целочисленный массив из 10 элементов.
//Заполняет массив случайными числами в диапазоне от -50 до 50.
//С помощью цикла for находит и выводит на экран:
//Все четные положительные элементы массива.
//Сумму всех отрицательных элементов массива.
